...
<body>
  ...
  <main>
    ...
    <?php if (isset($_POST['searchBtn']) && $_POST['search'] != "") {
      ...
      $fatchFormals = "SELECT *
    FROM shoe_info
    NATURAL JOIN sports_shoes WHERE shoe_info.ID=sports_shoes.ID AND  shoe_info.NAME='$search'";
              ...
              <div class="col  pb-4" style="width: fit-content; transform: scale(100%); ">
                ...
                <div class="p-1 mb-5 PARTS " style="  border:#335c67 solid 2px ;  box-shadow: 0 0 10px rgba(100, 100, 100, 1); border-radius: 10px; background-color: #403d39; width: 420px;">
                  <div class="d-flex" style="width:fit-content ;">
                    ...
                    <div class=" CARD m-1 " style="  border:#dee2e6 solid 2px; border-radius:10px ; background:white ; height: 25rem; width: 400px;">
                      <div class="ShoeChild" style="cursor: pointer;  width: fit-content; position:absolute;">
                        <div class="CHILD_IMGS" style="overflow: hidden; height: 0px; background: #403d39; border-radius: 2px  ; width: 90px; position:relative; top: -2px;">
                          ...
                          ?>
                              ...
                              <img src="<?php $photo = $rows['I_ADD'];
                                        echo $rows['I_ADD']; ?>" name="COLORIMG" onmouseover="SendImg('<?php echo $photo; ?>',this);" class="d-block CHILDIMG " style=" border-radius: 10px; padding: 2px; margin-top:5px; aspect-ratio:  6/8 ;   margin-inline-start: auto; margin-inline-end: auto;  width: 65px;" alt="">
                      ...
                      <img class="IMG float-end me-5" style="border-radius:10px; position:relative; left:0rem;  height: 18rem ; width: 18rem; margin-top: 3rem; object-fit:contain;" src="<?php echo $row['I_ADD']; ?>" alt="">
                    </div>
                    ...
                    <div name="informations" id="informations" style="position: relative;   display: none; left: 1rem; opacity: 0%; height: fit-content; width:fit-content ;" class=" box1 p-1 m-2">
                      <ul class="list-group rounded-3 ">
                        ...
                        <li id="ProductInfo " style="gap: 5px;" class="d-flex border-0 list-group-item">
                          ...
                          <span>
                            <span><?php $Dprice = $row['PRICE'] * $row['DISCOUNT'] / 100;
                                  $dp = $row['PRICE'] - $Dprice;
                                  echo  $row['PRICE'] - $Dprice;  ?>/-</span>
                          </span>
                        </li>
                      ...
                      <form action="CART_INFO.php" method="post">
                        ...
                        <button type="submit" name="ADD" class=" btn btn-warning ms-3 mt-2">ADD TO CART <i class="bi bi-cart-plus-fill"></i></button>
                      </form>
              ...
              <div class="p-1 mb-5 PARTS " style="  border:#335c67 solid 2px ;  box-shadow: 0 0 10px rgba(100, 100, 100, 1); border-radius: 10px; background-color: #403d39; width: 420px;">
                <div class="d-flex" style="width:fit-content ;">
                  ...
                  <div class=" CARD m-1 " style="  border:#dee2e6 solid 2px; border-radius:10px ; background:white ; height: 25rem; width: 400px;">
                    ...
                    <img class="IMG float-end me-5" style="border-radius:10px; position:relative; left:1rem;   height: 20rem ; width: 20rem; margin-top: 3rem; object-fit:contain;" src="<?php echo $row['I_ADD']; ?>" alt="">
                  </div>
  ...
  <script>
    let l = document.getElementById('informations').getElementsByTagName('ul')[0];
  </script>
