...
$Dprice=$_POST['PRICE']*$_POST['DISCOUNT']/100; $dp= $_POST['PRICE']-$Dprice;
        ...
        <div class="container d-flex border bg-light  rounded mt-2 " style="width: max-content; box-shadow: 0px 0px 10px #333;">
           ...
           <?php  echo $_POST['CLOTH']."  ".$_POST['PTYPE']." ".$_POST['PSubType'];?>
                <hr>
            </h3>
...
<div class="d-flex me-auto ms-auto border rounded text-center" style=" width: max-content;">
        <div class="  mt-2 ">
            ...
            <form action="add_db_product_cloths.php"  method="post">
            <div class=" form-check rounded  border form-check-inline">
              <div class="m-1">
  <input class="form-check-input " name="size[0]" value="S" type="checkbox" id="inlineCheckbox1"  >
  <label class="form-check-label mx-1" for="inlineCheckbox1">S</label>
...
<div class=" form-check rounded  border form-check-inline" >
              <div class="m-1">
  <input class="form-check-input " name="size[1]" value="M" type="checkbox" id="inlineCheckbox2" >
  <label class="form-check-label mx-1" for="inlineCheckbox1">M</label>
...
<div class=" form-check rounded  border form-check-inline">
              <div class="m-1">
  <input class="form-check-input " name="size[2]" value="L" type="checkbox" id="inlineCheckbox3" >
  <label class="form-check-label mx-1" for="inlineCheckbox1">L</label>
...
<div class=" form-check rounded  border form-check-inline">
              <div class="m-1">
  <input class="form-check-input" name="size[3]" value="XL" type="checkbox" id="inlineCheckbox4"  >
  <label class="form-check-label mx-1" for="inlineCheckbox1">XL</label>
...
<div class=" form-check rounded  border form-check-inline">
              <div class="m-1">
  <input class="form-check-input " name="size[4]" value="XXL" type="checkbox" id="inlineCheckbox5" >
  <label class="form-check-label mx-1" for="inlineCheckbox1">XLL</label>
...
<input type="hidden" name="PSubType" value="<?php echo $_POST['PSubType']; ?>">

<input type="hidden" name="PName" value="<?php echo $_POST['PName']; ?>">
<input type="hidden" name="CLOTH" value="<?php echo $_POST['CLOTH']; ?>">
