...
if($con->query("SELECT * FROM add_cart_info")->num_rows>0)
{
    $con->query("TRUNCATE TABLE add_cart_info");
}
...
<body style="background: #b0c4b1;">
    ...
    <div class="container" >
      ...
      if($_POST['ProType']=='cloth')
      {
       $ImgFetch="SELECT * FROM ".$Type."_cloths WHERE ID='$ID'";
      }
      else
      {
       $ImgFetch="SELECT * FROM ".$Type."_shoes WHERE ID='$ID'";
    ...
    ?> 
           ...
           ?>
                <div class="item-details">
                    ...
                    <p><strong>Size:</strong> <?php echo $_POST['Sizeinput'];?></p>
                    <p><strong>PRICE:</strong> <span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">&#8377;</span><?php $DISPRICE = intval($PRODUCT['PRICE']-$PRODUCT['PRICE']*$PRODUCT['DISCOUNT']/100); echo $DISPRICE;?>/-</p>
                    <p><strong>Quantity:  1 </strong> </p>
                    <hr>

                    <p style=""><strong>Grand Total:</strong> <span style="color:#333; font-weight:bolder;"><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">&#8377;</span><?php echo 1*$DISPRICE;?>/- </span></p>
        ...
        <div class="box">
            ...
            <div class="item">
                <div class="item-details">
                    ...
                    <p><strong>Phone Number:</strong> <?php echo $users['CONTACT'];?></p>
                </div>
            </div>
        </div>
    ...
    $DISPRICE= intval($PRODUCT['PRICE']-$PRODUCT['PRICE']*$PRODUCT['DISCOUNT']/100);
$set=$con->query("INSERT INTO add_cart_info VALUES('','$ID','".$PRODUCT['NAME']."','".$_SESSION['email']."','".strtoupper($TYPE)."','$ProType','$COLOR','".$_POST['Sizeinput']."','".$DISPRICE."','1')");
