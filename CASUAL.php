...
<body>
  ...
  ?>
    ...
    $fatchFormals="SELECT *
    FROM shoe_info
    NATURAL JOIN casual_shoes WHERE shoe_info.ID=casual_shoes.ID AND shoe_info.TYPE='casual'";
  ...
  <?php if(isset($_POST['searchBtn']) && $_POST['search']!=""  )
  {
    ...
    $fatchFormals="SELECT *
    FROM shoe_info
    NATURAL JOIN casual_shoes WHERE shoe_info.ID=casual_shoes.ID AND shoe_info.TYPE='casual' AND shoe_info.NAME='$search'";
       ...
       <div class="p-1 mb-5 PARTS " style="  border:#335c67 solid 2px ;  box-shadow: 0 0 10px rgba(100, 100, 100, 1); border-radius: 10px; background-color: #403d39; width: 420px;">
                <div class="d-flex" style="width:fit-content ;">
                    ...
                    <div class=" CARD m-1 "
                        ...
                        <?php 
                        $ID=$row['ID'];
                        $fetchChilds="SELECT * FROM child_casual WHERE ID = '$ID'";
